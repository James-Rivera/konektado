...
values
  ...
  (2, 'Miguel', 'Santos', 'Purok 2, Barangay San Pedro', 'provider',
   ...
   array['Minor home fix help', 'Computer setup', 'Phone setup'], 300, 1500, 'per_job',
  ...
  (8, 'Rodel', 'Villanueva', 'Purok 2, Barangay San Pedro', 'client',
   ...
   'Small home fix and yard helper',
   'Assists with minor home fixes, simple shelf and hinge adjustments, yard cleanup, and home setup tasks.',
   array['Minor home fix help', 'Yard or outdoor help', 'Home assistance'], 350, 1800, 'per_job',
   'Coordinates home maintenance and digital help',
   'Looks for clear rates and reliable schedules for household and document tasks.',
   array['Minor home fix help', 'Document formatting', 'Cleaning'], 'After 6 PM',
...
values
  ...
  (8, 'Minor home fix help', 'Minor home fixes and fixture adjustments', 'Small household fixes such as loose handles, cabinet hinges, shelves, curtain rods, and other non-licensed maintenance.', array['Small fix','Home maintenance','Tools ready'], '{}'::text[], 7, 'Weekdays after 4 PM', null, 500, 1200, 'per_job', true, 'experienced', true, 'Local home maintenance references available.', 'Barangay San Pedro', 'Purok 2, Barangay San Pedro', now() - interval '23 days'),
  (9, 'Minor home fix help', 'Cabinet and curtain rod adjustment', 'Tightens loose cabinet handles, checks hinges, and secures curtain rod brackets using basic hand tools.', array['Small fix','Home visit','Indoor'], '{}'::text[], 4, 'Morning visits by schedule', 'Non-licensed household fixes only.', 600, 1300, 'per_job', true, 'intermediate', false, null, 'Barangay San Pedro', 'Purok 4, Barangay San Pedro', now() - interval '22 days'),
...
values
  ...
  (5, 'Need loose shelf and curtain rod check', 'A shelf bracket and curtain rod mount are loose and need tightening with basic hand tools.', 'Home & Local Help', 'Minor home fix help', array['Minor home fix help','Small fix','Home visit'], '{}'::text[], 'Barangay San Pedro', 'Purok 2, Barangay San Pedro', 700, 1500, 'per_job', false, 'experienced', false, null, 1, 'Friday after 5 PM', 'open', now() - interval '14 hours'),
  (6, 'Need cabinet handle and hinge adjustment', 'Two kitchen cabinet handles are loose and one door hinge needs alignment.', 'Home & Local Help', 'Minor home fix help', array['Minor home fix help','Cabinet','Home visit'], '{}'::text[], 'Barangay San Pedro', 'Purok 4, Barangay San Pedro', 600, 1300, 'per_job', true, 'intermediate', false, null, 1, 'Tomorrow morning', 'open', now() - interval '1 day'),
  ...
  (9, 'Need outdoor wall painting assistant', 'Need help preparing and painting a small exterior wall section. Paint is already available.', 'Home & Local Help', 'Minor home fix help', array['Minor home fix help','Outdoor','Short task'], '{}'::text[], 'Barangay San Pedro', 'Purok 5, Barangay San Pedro', 700, 1800, 'per_job', true, 'intermediate', false, null, 1, 'Next weekend', 'open', now() - interval '1 day 9 hours'),

...
values
  (
    ...
    array['Repairs', 'Handyman', 'Home maintenance'],
  ...
  (
    ...
    array['Electrical', 'Light installation', 'Troubleshooting'],
  ...
  (
    ...
    array['Cleaning', 'Laundry', 'Organizing'],
  ...
  (
    ...
    'Checks electric fans, rice cookers, extension cords, and simple household appliances.',
    array['Appliance Repair', 'Electrical', 'Troubleshooting'],
    array['https://images.unsplash.com/photo-1558618666-fcd25c85cd64?auto=format&fit=crop&w=1200&q=80'],
    5,
    'Weekdays after 3:00 PM',
    'PHP 500 inspection, parts separate',
    'Barangay San Pedro',
    'Purok 4, Mabini Road',
    true,
    true,
...
values
  ...
  (
    ...
    'Cleaning',
    'Apartment cleaning',
    array['Cleaning', 'Morning', 'Supplies ready'],
    array['https://images.unsplash.com/photo-1581578731548-c64695cc6952?auto=format&fit=crop&w=1200&q=80'],
    'Barangay San Pedro',
    'Sampaguita Street',
    'Sampaguita Street',
  ...
  (
    ...
    array['Electrical', 'Weekend', 'Indoor and outdoor'],
  ...
  (
    ...
    array['Repairs', 'Cabinet', 'Completed'],
  ...
  (
    ...
    'Cleaning',
    'Yard cleanup',
    array['Cleaning', 'Gardening', 'Outdoor'],
  ...
  (
    ...
    'Hauling',
    'Moving help',
    array['Hauling', 'Furniture', 'Two workers'],

...
values
  ...
  (
    ...
    'Experienced helper for basic home repair, setup help, and household maintenance.',
...
values
  (
    ...
    'Helps with loose hinges, shelves, door handles, and small household maintenance tasks.',

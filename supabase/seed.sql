...
values
  (
    '00000000-0000-4000-8000-000000000003',
    'Minor home fix help, computer setup, home assistance',
    true,
...
values
  (
    ...
    'client',
    '{}',
    array['Minor home fix help', 'Cleaning', 'Document formatting'],
    '{}',
  ...
  (
    '00000000-0000-4000-8000-000000000003',
    'provider',
    array['Minor home fix help', 'Computer setup', 'Home assistance'],
    '{}',
    array['Printer setup'],
    '{}',
    now() - interval '17 days',
  ...
  (
    ...
    'client',
    '{}',
    array['Cleaning', 'Minor home fix help'],
    '{}',
    '{}',
    now() - interval '4 days',
    now() - interval '4 days',
...
values
  (
    ...
    array['Home & Local Help', 'Minor home fix help', 'Home maintenance'],
...
values
  (
    ...
    'Kitchen shelf bracket is loose. Need someone nearby who can inspect and make a small adjustment.',
    'Home & Local Help',
    'Minor home fix help',
  ...
  (
    ...
    '00000000-0000-4000-8000-000000000002',
    '00000000-0000-4000-8000-000000000002',
    'Adjust loose cabinet hinges',
    'Kitchen cabinet doors were adjusted and aligned.',
    'Home & Local Help',
    'Minor home fix help',

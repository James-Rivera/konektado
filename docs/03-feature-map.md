...
| Basic messaging | Messages tab, `app/conversation/[conversationId].tsx` | `conversations`, `messages` | P0 | Existing | Real inbox, job conversations, service conversations, text messages, quick prompts, context cards, details, report, and archive are connected. Attachments, calls, read receipts, push notifications, and group chat remain deferred. |
